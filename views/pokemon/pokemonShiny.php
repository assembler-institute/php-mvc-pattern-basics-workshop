...
<head>
    ...
    <script src="assets/js/utilsShiny.js" defer></script>
</head>
<body>
<nav id="botonesPokedex">
  ...
  <div id="tablaTodos" class="overflow-auto">
    <table class="table">
      ...
      ?>
        <tr id="<?=$pokemon["id"]?>" class="pickAPokemonShiny">
          <th scope="row"><?= $pokemon["id"]?></th>
          <td><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/shiny/<?= $pokemon["id"]?>.png" alt="">  </td>
          <td><?= $pokemon["name"];?></td>
...
<div id="pokemon" class="pokemonData">
        ...
        <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/shiny/<?= $pokemonSelectedTodo1[0][0]?>.png" alt="" onmouseover="hover(this)" onmouseout="unhover(this)">
        <p><?php
